...
function MySceneGraph(filename, scene, interface) {
	...
	this.blocks = ["scene", "views", "illumination", "lights", "textures", "materials", "transformations", "primitives", "components"];
...
MySceneGraph.prototype.onXMLReady=function() 
{
	...
	/* navigation to find if there's an error in errors or warnings  */
 	if(this.printErrors_Warings()){
		console("scene.dsx has errors, scene is not going to be apresented");
		return;
	}
